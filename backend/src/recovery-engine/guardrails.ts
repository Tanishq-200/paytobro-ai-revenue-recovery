import { FailureCategory, GuardrailsConfig, RecoveryActionType } from '../types/index.js';
...
export interface GuardrailCheckResult {
  allowed: boolean;
  reason?: string;
  enforcedAction?: RecoveryActionType;
}
...
export function evaluateGuardrails(
  ...
  attemptCount: number,
  probability: number,
  config: GuardrailsConfig = defaultGuardrails
